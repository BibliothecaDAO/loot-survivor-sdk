...
export const BeastCard = ({ beast }: { beast: Beast }) => {
    return (
        <RoundedContainer
            inner
            className="text-primary bg-beast-red/50 relative"
        >
            <div className="text-5xl  p-10 text-center uppercase">
                {beast.name}
            </div>
            ...
            <RoundedContainer className="absolute bottom-36 left-0 right-0 p-4 bg-black/90 mx-8">
                ...
                <div>
                    Giant: argghhh, who do you think you are!!! I will crush
                    your skull and eat your flesh! Time to die human.
                </div>
            </RoundedContainer>
            <RoundedContainer
                inner
