...
export class Survivor {
        ...
        switch (event.name) {
            case SELECTORS.StartGame:
                this.handleStartGameEvent(
                    event.event as EventTypes.StartGameEvent
                );
                break;
            ...
            case SELECTORS.SlayedBeast:
                this.handleSlayedBeastEvent(
                    event.event as EventTypes.SlayedBeastEvent
                );
                break;
            case SELECTORS.FleeFailed:
                this.handleFleeFailedEvent(
                    event.event as EventTypes.FleeFailedEvent
                );
                break;
    ...
    private handleHitByObstacleEvent(
    ...
    private handleAttackedBeastEvent(
    ...
    private handleFleeSucceededEvent(
    ...
    private handleEquippedItemsEvent(
