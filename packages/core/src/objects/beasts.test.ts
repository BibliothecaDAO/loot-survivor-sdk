...
describe("BeastManager", () => {
    ...
    describe("getArmorType", () => {
        it("should return the correct armor type for a given beast type", () => {
            ...
            expect(beastManager.getArmorType(BeastType.Hunter)).toBe(
                ArmorType.Hide
            );
            expect(beastManager.getArmorType(BeastType.Brute)).toBe(
                ArmorType.Metal
            );
        });
    });
    ...
    describe("getBeastType", () => {
        it("should return the correct beast type for a given beast", () => {
            expect(beastManager.getBeastType(Beasts.Bear)).toBe(
                BeastType.Hunter
            );
        });
    });
